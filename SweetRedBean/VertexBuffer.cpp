...
namespace Bind
{
	VertexBuffer::VertexBuffer(Graphics& graphics, const Dvtx::VertexBuffer& vbuf)
		: VertexBuffer(graphics, "?", vbuf)
	{
	}
	VertexBuffer::VertexBuffer(Graphics& graphics, const std::string& tag, const Dvtx::VertexBuffer& vbuf)
